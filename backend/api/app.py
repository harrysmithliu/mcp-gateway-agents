...
from backend.api.routes.admin_identity import router as admin_identity_router
...
from backend.api.routes.runtime_switches import router as runtime_switches_router
from backend.api.routes.trade import router as trade_router
from backend.api.routes.tools import router as tools_router
from backend.observability.logging import configure_structured_logging
from backend.observability.maintenance import enforce_maintenance_mode
from backend.observability.middleware import add_request_observability
...
def create_app() -> FastAPI:
    ...
    app.include_router(runtime_switches_router)
